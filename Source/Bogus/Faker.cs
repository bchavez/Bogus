...
public class Faker : ILocaleAware, IHasRandomizer, IHasContext
{
   ...
   /// <summary>
   /// A 0-based index variable that is automatically incremented on every
   /// new object generated by this <see cref="Faker{T}"/> instance over its lifetime.
   /// Useful for creating sequential IDs or unique usernames per Faker instance.
   /// <para>
   /// Example usage:
   /// <code>
