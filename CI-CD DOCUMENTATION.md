...
17. On the first run you will get the error:"The version of Java (1.8.0_275) you have used to run this analysis is deprecated and we stopped accepting it for newly created projects". Then go to your project in SonarCloud site.

18. From the **Administration** section select **Analysis Method**.

19.  On the "SonarCloud Automatic Analysis" turn "ON" the Automatic Analysis.

20. Re-run your workflow in Github after its finished you will get a second error:"You are running CI analysis while Automatic Analysis is enabled. Please consider disabling one or the other". Then go to your project in SonarCloud site.

21. From the **Administration** section select **Analysis Method**.

22. On the "SonarCloud Automatic Analysis" turn "OFF" the Automatic Analysis.

23. And you are ready to run your Workflow, its all set up.
