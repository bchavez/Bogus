...
namespace Bogus
{
   ...
   public class Randomizer
   {
      ...
      /// </summary>
      /// <returns></returns>
      internal decimal GenerateRandomMaximumPrecisionDecimal()
      {
      ...
      /// <returns></returns>
      internal decimal ScaleMaximumPrecisionDecimalToRange(decimal input, decimal min, decimal max)
      {
      ...
      public decimal Decimal(decimal min = 0.0m, decimal max = 1.0m)
      {
         ...
         var unscaledSample = GenerateRandomMaximumPrecisionDecimal();
